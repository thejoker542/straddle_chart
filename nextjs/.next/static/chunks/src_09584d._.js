(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_09584d._.js", {
...
function ModernChart() {
    _s();
    const [selectedIndex, setSelectedIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("NIFTY");
    const [selectedStrike, setSelectedStrike] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [strikeOptions, setStrikeOptions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [selectedTimeframe, setSelectedTimeframe] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("1");
    const [rawCEData, setRawCEData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [rawPEData, setRawPEData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ModernChart.useEffect": ()=>{
            fetchStrikePrices(selectedIndex);
        }
    }["ModernChart.useEffect"], [
        selectedIndex
    ]);
    const isMarketTime = (timestamp)=>{
    ...
    const updateChartWithData = (chartInstance, timestamps, straddleData, resampledCEData, resampledPEData)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ModernChart.useEffect": ()=>{
            if (rawCEData.length && rawPEData.length) {
                ...
                if (chartInstance.current) {
                    const straddleData = resampledCEData.map({
                        "ModernChart.useEffect.straddleData": (cePoint, index)=>{
                            const pePoint = resampledPEData[index];
                            return [
                                cePoint[0],
                                cePoint[1] + pePoint[1],
                    ...
                    }["ModernChart.useEffect.straddleData"]);
                    const timestamps = straddleData.map({
                        "ModernChart.useEffect.timestamps": (d)=>String(d[0])
                    }["ModernChart.useEffect.timestamps"]);
                    updateChartWithData(chartInstance.current, timestamps, straddleData, resampledCEData, resampledPEData);
                }
            }
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ModernChart.useEffect": ()=>{
            ...
            chartInstance.current = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$echarts$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.init(chartRef.current);
            const option = {
                tooltip: {
                    trigger: 'axis',
                    ...
                    formatter: {
                        "ModernChart.useEffect": (params)=>{
                            const date = params[0].axisValue;
                            let result = `<div class="font-medium">${date}</div>`;
                            params.forEach({
                                "ModernChart.useEffect": (param)=>{
              ...
              <span class="font-medium">${param.value.toFixed(2)}</span>
                ...
                xAxis: {
                    ...
                    axisLabel: {
                        ...
                        showMaxLabel: true,
                        interval: {
                            "ModernChart.useEffect": (index, value)=>{
                                if (typeof value !== 'string') return false;
                                const parts = value.split(' ');
                                if (parts.length !== 2) return false;
                                const timeValue = parseInt(parts[1].replace(':', ''));
            ...
            const handleResize = {
                "ModernChart.useEffect.handleResize": ()=>{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: watchlistData.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: `p-4 border-b border-gray-100 cursor-pointer hover:bg-gray-50 ${selectedIndex === item.symbol ? 'bg-blue-50' : ''}`,
...
_s(ModernChart, "CSFsCKRlcsf680CG0UboyPWvD3I=");
_c = ModernChart;
var _c;
__turbopack_refresh__.register(_c, "ModernChart");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_09584d._.js.map